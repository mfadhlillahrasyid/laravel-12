...
<head>
    ...
    <title>Larave 12 - Preline Hero Sections</title>
</head>

<body class="bg-neutral-100 dark:bg-neutral-900 max-w-[85rem] mx-auto min-h-screen flex items-center justify-center">
    <!-- Hero -->
    <div
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-10">
            ...
            <div class="mt-5 max-w-3xl text-center mx-auto">
                <p class="text-lg text-gray-600 dark:text-neutral-400">Preline is a large open-source project, crafted
                    with Tailwind CSS framework by Hmlstream.</p>
            </div>
